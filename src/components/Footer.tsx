        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">(45) 9 9986-6869</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-5 w-5 text-amber-500" />
                <div className="text-gray-300">
                  <div>Rua Altemar Dutra, 127</div>
                  <div>Cascavel, PR</div>
                </div>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://instagram.com/herixx._cm" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gradient-to-r hover:from-amber-500 hover:to-amber-600 p-3 rounded-full transition-all duration-300 border border-amber-600/30"
              >
